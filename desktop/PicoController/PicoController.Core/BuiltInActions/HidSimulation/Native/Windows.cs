...
internal class WindowsInputSimulator : INativeInputSimulator
{
    ...
    {
        var cursorPos = pointerPosition ?? (Point)GetCursorPosition();
        ...
        var input = new INPUT
        {
            ...
            union = new InputUnion
            {
                ...
                {
                    dwFlags     = axis switch { Axis.Horizontal => MOUSEEVENTF.HWHEEL, _ => MOUSEEVENTF.WHEEL },
